...
class Merchant(Base):
    ...
    whatsapp_app_id = Column(String(255), nullable=True)
    whatsapp_app_secret = Column(Text, nullable=True)
    whatsapp_access_token = Column(Text, nullable=True)
    whatsapp_business_number_id = Column(String(255), nullable=True)
